...
import org.jppf.application.bean.BWrapper;
 ...
 */
public class TemplateJPPFTask extends AbstractTask<String> implements DataProviderHolder {
...
private transient DataProvider dataProvider;	
  ...
  public void run() {
    ...
    // ...
    BWrapper wrapper = (BWrapper)dataProvider.getParameter("bwrapper");
    System.out.println("BWrapper get from provider (" + wrapper.toString() + ")");
    wrapper.setErrMsg("Test from JPPF Task");
    
    // eventually set the execution results
    setResult(wrapper.toString());
  }
